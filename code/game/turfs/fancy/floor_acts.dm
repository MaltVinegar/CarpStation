...
/turf/fancyturf/fancy/floor/ex_act(severity)
	//set src in oview(1)
	var/obj/effect/shield/turf/fancyturf_shield = getEffectShield()
...
/turf/fancyturf/fancy/floor/fire_act(datum/gas_mixture/air, exposed_temperature, exposed_volume)
...
/turf/fancyturf/fancy/floor/proc/get_damage_temperature()
	return flooring ? flooring.damage_temperature : null

/turf/fancyturf/fancy/floor/adjacent_fire_act(turf/fancy/floor/adj_turf, datum/gas_mixture/adj_air, adj_temp, adj_volume)
