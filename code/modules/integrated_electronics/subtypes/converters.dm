...
/obj/item/integrated_circuit/converter/hsv2hex/do_work()
	...
	if(IMPORTEDisnum_safe(hue)&&IMPORTEDisnum_safe(saturation)&&IMPORTEDisnum_safe(value))
...
/obj/item/integrated_circuit/converter/rgb2hex/do_work()
	...
	if(IMPORTEDisnum_safe(red)&&IMPORTEDisnum_safe(green)&&IMPORTEDisnum_safe(blue))
