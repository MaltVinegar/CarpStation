...
/obj/effect/mob_spawn/human/corpse/damaged/legioninfested/Initialize()
	...
	switch(type)
		if("Miner")
			...
			if(prob(20))
				suit = pickweight(list(/obj/item/clothing/suit/hooded/explorer = 6, /obj/item/clothing/suit/hooded/explorer/exo = 6, /obj/item/clothing/suit/hooded/explorer/seva = 6))
			if(prob(10))
