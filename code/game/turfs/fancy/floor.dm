...
/turf/fancyturf/fancy/floor/Entered(atom/movable/AM, atom/old_loc)
	..(AM, old_loc)
	if (flooring)
		flooring.Entered(AM, old_loc)

/turf/fancyturf/fancy/floor/is_plating()
	if (flooring)
...
/turf/fancyturf/fancy/floor/New(newloc, floortype)
...
/turf/fancyturf/fancy/floor/proc/set_flooring(var/decl/flooring/newflooring, var/update = TRUE)
...
/turf/fancyturf/fancy/floor/examine(mob/user)
	.=..()
	if (health < maxHealth)
...
/turf/fancyturf/fancy/floor/proc/make_plating(var/place_product, var/defer_icon_update)
...
/turf/fancyturf/fancy/floor/levelupdate()
	if (flooring)
...
/turf/fancyturf/fancy/floor/proc/is_damaged()
