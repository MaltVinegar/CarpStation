/turf/fancyturf/fancy/floor/attackby(obj/item/I, mob/user)

	if(!I || !user)
		return 0

	if(istype(src, /turf/fancyturf/fancy/floor/plating/under) && istype(I, /obj/item/stack/material/cyborg/steel))
...
/turf/fancyturf/fancy/floor/can_build_cable(var/mob/user)
