...
/datum/antagonist/blood_contract/proc/start_the_hunt()
	...
	var/obj/effect/mine/pickup/bloodbath/contract/B = new(H)
	B.duration = duration

	INVOKE_ASYNC(B, /obj/effect/mine/pickup/bloodbath/contract/.proc/mineEffect, H) //could use moving out from the mine
