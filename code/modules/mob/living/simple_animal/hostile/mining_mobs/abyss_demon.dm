/mob/living/simple_animal/hostile/asteroid/abyss_demon
	...
	speed = 1
	move_to_delay = 2
	projectiletype = /obj/projectile/temp/basilisk/firebolt
...
obj/projectile/temp/basilisk/firebolt
	name = "firebolt"
...
obj/projectile/temp/basilisk/firebolt/on_hit(atom/target, blocked = FALSE)
	. = ..()
	if(. && isliving(target))
