...
/turf/fancyturf/Destroy()
	turfs -= src
	..()
	return QDEL_HINT_IWILLGC

/turf/fancyturf/ex_act(severity)
	return 0

/turf/fancyturf/proc/is_solid_structure()
	return 1

/turf/fancyturf/proc/is_space()
	return 0

/turf/fancyturf/proc/is_intact()
	return 0

/turf/fancyturf/attack_hand(mob/user)
...
/turf/fancyturf/Enter(atom/movable/mover as mob|obj, atom/forget as mob|obj|turf|area)
...
/turf/fancyturf/Entered(atom/atom as mob|obj)
...
/turf/fancyturf/proc/adjacent_fire_act(turf/fancy/floor/source, temperature, volume)
	return

/turf/fancyturf/proc/is_plating()
	return FALSE

/turf/fancyturf/proc/inertial_drift(atom/movable/A as mob|obj)
...
/turf/fancyturf/proc/levelupdate()
	for(var/obj/O in src)
		O.hide(O.hides_under_flooring() && !is_plating())
		SEND_SIGNAL(O, CONSIG_TURF_LEVELUPDATE, !is_plating())

/turf/fancyturf/proc/AdjacentTurfs()
	var/L[] = new()
	for(var/turf/fancyturf/fancy/t in oview(src,1))
		if(!t.density)
			if(!LinkBlocked(src, t) && !TurfBlockedNonWindow(t))
				L.Add(t)
	return L

/turf/fancyturf/proc/CardinalTurfs()
	var/L[] = new()
	for(var/turf/fancyturf/fancy/T in AdjacentTurfs())
		if(T.x == src.x || T.y == src.y)
			L.Add(T)
	return L

/turf/fancyturf/proc/Distance(turf/t)
	if(get_dist(src,t) == 1)
...
/turf/fancyturf/proc/AdjacentTurfsSpace()
	var/L[] = new()
	for(var/turf/fancyturf/t in oview(src,1))
		if(!t.density)
			if(!LinkBlocked(src, t) && !TurfBlockedNonWindow(t))
				L.Add(t)
	return L

/turf/fancyturf/proc/contains_dense_objects()
	if(density)
		return 1
...
/turf/fancyturf/get_footstep_sound(var/mobtype)
...
/turf/fancyturf/fancy/floor/get_footstep_sound(var/mobtype)
