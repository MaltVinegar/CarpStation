...
/datum/integrated_io/lists/proc/interact(mob/user)
	...
	t += "<a href='?src=[IMPORTEDREF(src)]'>\[Refresh\]</a>  |  "
	t += "<a href='?src=[IMPORTEDREF(src)];add=1'>\[Add\]</a>  |  "
	t += "<a href='?src=[IMPORTEDREF(src)];remove=1'>\[Remove\]</a>  |  "
	t += "<a href='?src=[IMPORTEDREF(src)];edit=1'>\[Edit\]</a>  |  "
	t += "<a href='?src=[IMPORTEDREF(src)];swap=1'>\[Swap\]</a>  |  "
	t += "<a href='?src=[IMPORTEDREF(src)];clear=1'>\[Clear\]</a><br>"
	t += "<hr>"
	var/i = 0
	for(var/line in my_list)
		i++
		t += "#[i] | [display_data(line)]  |  "
		t += "<a href='?src=[IMPORTEDREF(src)];edit=1;pos=[i]'>\[Edit\]</a>  |  "
		t += "<a href='?src=[IMPORTEDREF(src)];remove=1;pos=[i]'>\[Remove\]</a><br>"
	user << browse(t, "window=list_pin_[IMPORTEDREF(src)];size=500x400")
