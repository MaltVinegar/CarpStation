/obj/machinery/chem_condenser
	name = "chem condenser"
	desc = "Merges chemicals using bluespace crystals."
	density = TRUE
	...
	circuit = /obj/item/circuitboard/machine/chem_condenser
	...
	// Will be the Main Beaker
	var/obj/item/reagent_containers/beaker = null

	// Doner Beaker
	var/obj/item/reagent_containers/slavebeaker = null

/obj/machinery/chem_condenser/Initialize()
	. = ..()
	if(is_operational)
		begin_processing()
	update_icon()

/obj/machinery/chem_condenser/Destroy()
	QDEL_NULL(beaker)
	QDEL_NULL(cell)
	return ..()

/obj/machinery/chem_condenser/examine(mob/user)
	. = ..()
	if(panel_open)
...
/obj/machinery/chem_condenser/on_set_is_operational(old_value)
...
/obj/machinery/chem_condenser/process(delta_time)
...
/obj/machinery/chem_condenser/proc/display_beaker()
	var/mutable_appearance/b_o = beaker_overlay || mutable_appearance(icon, "disp_beaker")
	b_o.pixel_y = -4
	b_o.pixel_x = -7
	return b_o

/obj/machinery/chem_condenser/proc/work_animation()
	if(working_state)
		flick(working_state,src)

/obj/machinery/chem_condenser/update_icon_state()
	icon_state = "[(nopower_state && !powered()) ? nopower_state : initial(icon_state)]"

/obj/machinery/chem_condenser/update_overlays()
	. = ..()
...
/obj/machinery/chem_condenser/emag_act(mob/user)
...
/obj/machinery/chem_condenser/ex_act(severity, target)
	if(severity < 3)
		..()

/obj/machinery/chem_condenser/contents_explosion(severity, target)
	..()
	if(beaker)
		switch(severity)
...
/obj/machinery/chem_condenser/handle_atom_del(atom/A)
	..()
	if(A == beaker)
		beaker = null
		cut_overlays()

/obj/machinery/chem_condenser/ui_interact(mob/user, datum/tgui/ui)
	ui = SStgui.try_update_ui(user, src, ui)
	if(!ui)
		ui = new(user, src, "ChemCondenser", name)
		if(user.hallucinating())
			ui.set_autoupdate(FALSE) //to not ruin the immersion by constantly changing the fake chemicals
		ui.open()

/obj/machinery/chem_condenser/ui_data(mob/user)
	var/data = list()
	data["amount"] = amount
...
/obj/machinery/chem_condenser/ui_act(action, params)
	. = ..()
	if(.)
		return
	switch(action)
...
/obj/machinery/chem_condenser/attackby(obj/item/I, mob/user, params)
...
/obj/machinery/chem_condenser/get_cell()
	return cell

/obj/machinery/chem_condenser/emp_act(severity)
	. = ..()
	if(. & EMP_PROTECT_SELF)
		return
...
/obj/machinery/chem_condenser/RefreshParts()
...
/obj/machinery/chem_condenser/proc/replace_beaker(mob/living/user, obj/item/reagent_containers/new_beaker)
	if(!user)
		return FALSE
	if(beaker)
...
/obj/machinery/chem_condenser/on_deconstruction()
	cell = null
	if(beaker)
...
/obj/machinery/chem_condenser/AltClick(mob/living/user)
	. = ..()
	if(!can_interact(user) || !user.canUseTopic(src, BE_CLOSE, FALSE, NO_TK))
		return
	replace_beaker(user)

/obj/machinery/chem_condenser/drinks/Initialize()
	. = ..()
	AddComponent(/datum/component/simple_rotation, ROTATION_ALTCLICK | ROTATION_CLOCKWISE)

/obj/machinery/chem_condenser/drinks/setDir()
	var/old = dir
	. = ..()
	if(dir != old)
		update_icon()  // the beaker needs to be re-positioned if we rotate

/obj/machinery/chem_condenser/drinks/display_beaker()
	var/mutable_appearance/b_o = beaker_overlay || mutable_appearance(icon, "disp_beaker")
	switch(dir)
		if(NORTH)
			b_o.pixel_y = 7
...
/obj/machinery/chem_condenser/drinks
	name = "soda dispenser"
	...
	circuit = /obj/item/circuitboard/machine/chem_condenser/drinks
	working_state = null
	nopower_state = null
...
/obj/machinery/chem_condenser/drinks/fullupgrade //fully ugpraded stock parts, emagged
	desc = "Contains a large reservoir of soft drinks. This model has had its safeties shorted out."
	obj_flags = CAN_BE_HIT | EMAGGED
	flags_1 = NODECONSTRUCT_1

/obj/machinery/chem_condenser/drinks/fullupgrade/Initialize()
	. = ..()
	...
	component_parts += new /obj/item/circuitboard/machine/chem_condenser/drinks(src)
...
/obj/machinery/chem_condenser/drinks/beer
	name = "booze dispenser"
	desc = "Contains a large reservoir of the good stuff."
	icon = 'icons/obj/chemical.dmi'
	icon_state = "booze_dispenser"
	circuit = /obj/item/circuitboard/machine/chem_condenser/drinks/beer
	dispensable_reagents = list(
...
/obj/machinery/chem_condenser/drinks/beer/fullupgrade //fully ugpraded stock parts, emagged
	desc = "Contains a large reservoir of the good stuff. This model has had its safeties shorted out."
	obj_flags = CAN_BE_HIT | EMAGGED
	flags_1 = NODECONSTRUCT_1

/obj/machinery/chem_condenser/drinks/beer/fullupgrade/Initialize()
	. = ..()
	dispensable_reagents |= emagged_reagents //adds emagged reagents
	...
	component_parts = list()
	component_parts += new /obj/item/circuitboard/machine/chem_condenser/drinks/beer(src)
	component_parts += new /obj/item/stock_parts/matter_bin/bluespace(src)
	component_parts += new /obj/item/stock_parts/matter_bin/bluespace(src)
	component_parts += new /obj/item/stock_parts/capacitor/quadratic(src)
	component_parts += new /obj/item/stock_parts/manipulator/femto(src)
...
/obj/machinery/chem_condenser/mutagen
...
/obj/machinery/chem_condenser/mutagensaltpeter
...
/obj/machinery/chem_condenser/mutagensaltpeter/Initialize()
	. = ..()
	...
	component_parts = list()
	component_parts += new /obj/item/circuitboard/machine/chem_condenser(src)
	component_parts += new /obj/item/stock_parts/matter_bin/bluespace(src)
	component_parts += new /obj/item/stock_parts/matter_bin/bluespace(src)
	component_parts += new /obj/item/stock_parts/capacitor/quadratic(src)
	component_parts += new /obj/item/stock_parts/manipulator/femto(src)
...
/obj/machinery/chem_condenser/fullupgrade //fully ugpraded stock parts, emagged
	desc = "Creates and dispenses chemicals. This model has had its safeties shorted out."
	obj_flags = CAN_BE_HIT | EMAGGED
	flags_1 = NODECONSTRUCT_1

/obj/machinery/chem_condenser/fullupgrade/Initialize()
	. = ..()
	dispensable_reagents |= emagged_reagents //adds emagged reagents
...
/obj/machinery/chem_condenser/abductor
	name = "reagent synthesizer"
	desc = "Synthesizes a variety of reagents using proto-matter."
	icon = 'icons/obj/abductor.dmi'
	icon_state = "chem_condenser"
	has_panel_overlay = FALSE
	circuit = /obj/item/circuitboard/machine/chem_condenser/abductor
	working_state = null
	nopower_state = null
	dispensable_reagents = list(
...
/obj/machinery/chem_condenser/abductor/Initialize()
	. = ..()
