...
/obj/item/kinetic_crusher
	...
	var/destabilizer_type = /obj/projectile/destabilizer

/obj/item/kinetic_crusher/premium
	icon_state = "crusher_prem"
	inhand_icon_state = "crusher_prem0"
	...
	backstab_bonus = 40
	light_range = 8
	destabilizer_type = /obj/projectile/destabilizer/premium

/obj/projectile/destabilizer/premium
...
/obj/item/kinetic_crusher/afterattack(atom/target, mob/living/user, proximity_flag, clickparams)
	...
	if(!proximity_flag && charged)//Mark a target, or mine a tile.
		...
		if(!isturf(proj_turf))
			return
		var/obj/projectile/destabilizer/D = new destabilizer_type(proj_turf)
		for(var/t in trophies)
			var/obj/item/crusher_trophy/T = t
...
/obj/item/crusher_trophy/rogue_ai/on_projectile_fire(obj/projectile/destabilizer/marker, mob/living/user)
	if(seeker_shot)
