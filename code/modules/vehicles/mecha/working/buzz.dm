/obj/vehicle/sealed/mecha/working/ripley/buzz
	name = "\proper Buzz"
...
/obj/vehicle/sealed/mecha/working/ripley/buzz/collect_ore()
	return FALSE //we're not actually a mining mech

/obj/vehicle/sealed/mecha/working/ripley/buzz/Initialize()
	..()
...
/obj/vehicle/sealed/mecha/working/ripley/buzz/update_pressure()
...
/obj/vehicle/sealed/mecha/working/ripley/buzz/moved_inside(mob/living/carbon/human/H)
	. = ..()
	if(.)
		for(var/mob/living/B in occupants)
			storedsight = B.sight
			storedsee_in_dark = B.see_in_dark
			B.sight |= SEE_TURFS
			B.see_in_dark = 7

/obj/vehicle/sealed/mecha/working/ripley/buzz/after_remove_occupant()
	for(var/mob/living/B in occupants)
		B.sight = storedsight
...
/obj/vehicle/sealed/mecha/working/ripley/buzz/mmi_moved_inside(obj/item/mmi/M, mob/user)
	. = ..()
	if(.)
