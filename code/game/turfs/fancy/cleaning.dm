...
/turf/fancyturf/fancy/proc/wet_floor(var/wet_val = 1, var/force_wet = FALSE)
...
/turf/fancyturf/fancy/proc/unwet_floor(var/check_very_wet)
	wet = 0
	if(wet_overlay)
		overlays -= wet_overlay
		wet_overlay = null
...
/turf/fancyturf/fancy/clean_blood()
	for(var/obj/effect/decal/cleanable/blood/B in contents)
		B.clean_blood()
	..()

//expects an atom containing the reagents used to clean the turf
/turf/fancyturf/proc/clean(atom/source, mob/user)
...
/turf/fancyturf/proc/clean_partial(atom/source, mob/user, var/count = 1)
	if (!count)
		return
...
/turf/fancyturf/proc/update_blood_overlays()
	return
...
/turf/fancyturf/fancy/proc/AddTracks(var/typepath,var/bloodDNA,var/comingdir,var/goingdir,var/bloodcolor="#A10808")
...
/turf/fancyturf/fancy/add_blood(mob/living/carbon/human/M as mob)
	if (!..())
		return 0
...
/turf/fancyturf/fancy/proc/add_blood_floor(mob/living/carbon/M as mob)
