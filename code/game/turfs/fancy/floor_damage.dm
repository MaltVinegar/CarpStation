/turf/fancyturf/fancy/floor/proc/gets_drilled()
	return

/turf/fancyturf/fancy/floor/proc/break_tile_to_plating()
	if(!is_plating())
		make_plating()
	break_tile()

/turf/fancyturf/fancy/floor/proc/break_tile(rust)
...
/turf/fancyturf/fancy/floor/proc/burn_tile()
...
/turf/fancyturf/fancy/floor/proc/take_damage(var/damage, var/damage_type = BRUTE, var/ignore_resistance = FALSE)
	if (is_hole)
...
/proc/damage_floor_at(var/x, var/y, var/z, var/damage, var/damage_type, var/ignore_resistance)
	var/turf/fancyturf/fancy/floor/F = locate(x,y,z)
	if (istype(F))
