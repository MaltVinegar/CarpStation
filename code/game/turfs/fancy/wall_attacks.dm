//Interactions
/turf/fancyturf/fancy/wall/proc/toggle_open(var/mob/user)
...
/turf/fancyturf/fancy/wall/proc/fail_smash(var/mob/user)
	to_chat(user, SPAN_DANGER("You smash against the wall!"))
	user.do_attack_animation(src)
	take_damage(rand(25,75))

/turf/fancyturf/fancy/wall/proc/success_smash(var/mob/user)
	to_chat(user, SPAN_DANGER("You smash through the wall!"))
	user.do_attack_animation(src)
	spawn(1)
		dismantle_wall(1)

/turf/fancyturf/fancy/wall/proc/try_touch(var/mob/user, var/rotting)
...
/turf/fancyturf/fancy/wall/attack_hand(var/mob/user)
...
/turf/fancyturf/fancy/wall/attack_generic(var/mob/user, var/damage, var/attack_message, var/wallbreaker)
...
/turf/fancyturf/fancy/wall/attackby(obj/item/I, mob/user)
	...
	if(!istype(user.loc, /turf/fancyturf))	return	//can't do this stuff whilst inside objects and such
